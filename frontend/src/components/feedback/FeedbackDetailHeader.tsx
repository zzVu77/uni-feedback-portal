...
const FeedbackDetailHeader = ({ type = "student", data }: Props) => {
  ...
  return (
    <>
      <div className="flex h-full w-full flex-col gap-5 rounded-[24px] border border-gray-200/90 bg-white/70 px-6 py-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl lg:px-8">
        {/* Title */}
