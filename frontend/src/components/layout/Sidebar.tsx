...
export default function Sidebar({
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          "h-screen w-64 flex-col gap-4 border-r border-slate-800 bg-slate-900 text-white transition-all",
          showOnMobile ? "flex w-full" : "hidden lg:flex",
        )}
      >
        <div className="flex items-center justify-center border-b border-slate-800 px-6 py-8">
          <Image
            src={ASSETS.LOGO_UTE}
            alt="Logo UTE"
            height={100}
        ...
        <div className="flex h-full flex-col justify-between border-t border-slate-800">
